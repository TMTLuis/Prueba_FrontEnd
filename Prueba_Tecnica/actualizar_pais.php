...
$id = $_GET["id"];
$usuarios = "SELECT * FROM casos_paises WHERE pais = '$id'"
?>
...
<body>
    ...
    <thead>
      <tr>
        ...
        <td>
        <input type="text" name="bandera" value="<?php echo $row["bandera"];?>">
        </td>
        
        <td>
        <input type="text" name="casos_confirmados" value="<?php echo $row["casos_confirmados"];?>">
        </td>
        
        <td>
        <input type="text" name="muertes" value="<?php echo $row["muertes"];?>">
        </td>
